                    ...
                    <div class="column is-6">
                        <div class="columns is-multiline is-centered">
                            ...
                            <div class="column is-12">
                                ...
                                <textarea class="input @error('content') is-danger @enderror" name="content" cols="30"
                                    rows="10">{{ old('content') }}</textarea>
                                @error('content')
                                    <p class="help is-danger">{{ $message }} </p>
                                @enderror
                            </div>
                            <div class="column is-12"><input class="button is-light is-primary is-outlined" type="submit"
                                    value="Send"></div>
                        </div>
                    </div>
                </div>
